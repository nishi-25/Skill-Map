...
# last_updated: そのページの内容を実際に編集した日(YYYY-MM-DD)。内容を変更したら必ず更新する。

PAGES = [
    {"key": "index", "url": "/manual", "title": "システム概要", "icon": "bi-map", "group": "はじめに", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "quickstart", "url": "/manual/quickstart", "title": "クイックスタート", "icon": "bi-play-circle-fill", "group": "はじめに", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "roles", "url": "/manual/roles", "title": "ロール・権限一覧", "icon": "bi-person-badge", "group": "はじめに", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "login", "url": "/manual/login", "title": "ログイン・初期設定", "icon": "bi-box-arrow-in-right", "group": "はじめに", "min_role": None, "last_updated": "2026-06-21"},

    {"key": "dashboard", "url": "/manual/dashboard", "title": "ダッシュボード", "icon": "bi-speedometer2", "group": "全ユーザー共通", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "profile", "url": "/manual/profile", "title": "プロフィール・表示設定", "icon": "bi-person-circle", "group": "全ユーザー共通", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "search", "url": "/manual/search", "title": "グローバル検索", "icon": "bi-search", "group": "全ユーザー共通", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "tickets", "url": "/manual/tickets", "title": "問い合わせ・要望", "icon": "bi-chat-dots-fill", "group": "全ユーザー共通", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "wiki", "url": "/manual/wiki", "title": "Wiki", "icon": "bi-journal-text", "group": "全ユーザー共通", "min_role": None, "last_updated": "2026-06-21"},

    {"key": "skillmap", "url": "/manual/skillmap", "title": "スキルマップ（自己申告）", "icon": "bi-lightning-charge-fill", "group": "User機能", "min_role": None, "last_updated": "2026-06-30"},
    {"key": "business-map", "url": "/manual/business-map", "title": "業務マップで選択する", "icon": "bi-diagram-3", "group": "User機能", "min_role": None, "last_updated": "2026-06-30"},
    {"key": "my-approvals", "url": "/manual/my-approvals", "title": "自分の申請状況", "icon": "bi-send", "group": "User機能", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "timeline", "url": "/manual/timeline", "title": "成長タイムライン", "icon": "bi-graph-up-arrow", "group": "User機能", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "education", "url": "/manual/education", "title": "教育リソース", "icon": "bi-mortarboard-fill", "group": "User機能", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "certifications", "url": "/manual/certifications", "title": "資格登録", "icon": "bi-patch-check-fill", "group": "User機能", "min_role": None, "last_updated": "2026-06-21"},
    ...
    {"key": "categories", "url": "/manual/categories", "title": "カテゴリー管理", "icon": "bi-tags", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "groups", "url": "/manual/groups", "title": "グループ管理", "icon": "bi-people-fill", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "education-mgmt", "url": "/manual/education-mgmt", "title": "教育リソース管理", "icon": "bi-mortarboard-fill", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "business-map-manage", "url": "/manual/business-map-manage", "title": "業務マップ管理", "icon": "bi-diagram-3-fill", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "certifications-matrix", "url": "/manual/certifications-matrix", "title": "資格マトリクス", "icon": "bi-patch-check", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "certifications-catalog", "url": "/manual/certifications-catalog", "title": "資格マスタ管理", "icon": "bi-collection-fill", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},
    {"key": "exams-management", "url": "/manual/exams-management", "title": "試験管理", "icon": "bi-clipboard-check", "group": "Manager以上", "min_role": "manager", "last_updated": "2026-06-21"},

    {"key": "usecase-user", "url": "/manual/usecase/user", "title": "ユースケース: Userの操作フロー", "icon": "bi-person-walking", "group": "ユースケース", "min_role": None, "last_updated": "2026-06-21"},
    {"key": "usecase-manager", "url": "/manual/usecase/manager", "title": "ユースケース: Managerの操作フロー", "icon": "bi-person-gear", "group": "ユースケース", "min_role": None, "last_updated": "2026-06-21"},

    {"key": "api", "url": "/manual/api", "title": "APIリファレンス", "icon": "bi-code-slash", "group": "APIリファレンス", "min_role": None, "last_updated": "2026-06-21"},

    {"key": "faq", "url": "/manual/faq", "title": "よくある質問", "icon": "bi-question-circle", "group": "その他", "min_role": None, "last_updated": "2026-06-30"},

    {"key": "admin-index", "url": "/manual/admin", "title": "管理者の役割", "icon": "bi-shield-check", "group": "Admin専用", "min_role": "admin", "last_updated": "2026-06-21"},
    {"key": "admin-users", "url": "/manual/admin/users", "title": "ユーザー管理・パスワードリセット", "icon": "bi-people", "group": "Admin専用", "min_role": "admin", "last_updated": "2026-06-21"},
    {"key": "admin-mail", "url": "/manual/admin/mail", "title": "メール設定", "icon": "bi-envelope-at", "group": "Admin専用", "min_role": "admin", "last_updated": "2026-06-21"},
    {"key": "admin-maintenance", "url": "/manual/admin/maintenance", "title": "運用・保守（Docker / 初期化 / トラブルシューティング）", "icon": "bi-tools", "group": "Admin専用", "min_role": "admin", "last_updated": "2026-06-21"},
]
...
MANUAL_INDEX = [
    ...
    {"page_url": "/manual/exams-my", "anchor": "mistake", "title": "試験の提出を間違えた場合", "breadcrumb": "User機能 › 試験を受ける",
     "keywords": "試験 提出ミス 取り消し 再受験 再割り当て",
     "snippet": "自分で取り消せないため、Manager/Adminに再割り当てを依頼すると最初から再受験できます。"},
    ...
    {"page_url": "/manual/approvals", "anchor": "judgment", "title": "承認・差し戻しの判断基準", "breadcrumb": "Manager以上 › 承認依頼",
     "keywords": "判断基準 差し戻し 却下 不適切な申告 迷ったら",
     "snippet": "実態と合わない場合はまず差し戻して根拠を求める、取り消し申請に疑問があれば却下する、といった判断の目安です。"},
    ...
    {"page_url": "/manual/exams-management", "anchor": "grading-mistake", "title": "採点を間違えて確定した場合", "breadcrumb": "Manager以上 › 試験管理",
     "keywords": "採点ミス 再割り当て リセット 採点し直し",
     "snippet": "同じユーザーに再割り当てすると回答・採点・提出物がリセットされ、最初からやり直せます。"},
